...
import movieRecommend.ALSAlgorithmParams
...
class ALSModel(
    ...
    val movieSortByRate: Array[(String, Double)],
    val productFeaturesMap: Map[Int, Array[Double]])
  ...
  def save(id: String, params: ALSAlgorithmParams,
    ...
    sc.parallelize(Seq(movieSortByRate))
      .saveAsObjectFile(s"/tmp/${id}/movieSortByRate")
    sc.parallelize(Seq(productFeaturesMap))
      .saveAsObjectFile(s"/tmp/${id}/productFeaturesMap")
    true
  }
...
object ALSModel
  ...
  def apply(id: String, params: ALSAlgorithmParams,
    ...
    movieSortByRate = sc.get
      .objectFile[Array[(String, Double)]](s"/tmp/${id}/movieSortByRate").first,
      productFeaturesMap = sc.get
        .objectFile[Map[Int, Array[Double]]](s"/tmp/${id}/productFeaturesMap").first
    )
  }
}
